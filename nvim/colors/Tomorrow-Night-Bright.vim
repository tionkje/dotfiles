...
let s:purple     = "c397d8"
let s:window     = "4d5057"
let s:statusline = "268bd2"
let s:statusline2 = "053955"
" 82b414
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  " Custom statusline highlighting
	call <SID>X("User1", s:foreground, "NONE", "reverse")
	call <SID>X("User2", s:background2, s:background2, "NONE")
	call <SID>X("User3", "000000", s:yellow, "NONE")
  " hi User1 NONE
  " hi User2 NONE
	...
	call <SID>X("Search", "000000", s:yellow, "")
	call <SID>X("TabLine", s:window, s:foreground, "reverse")
	call <SID>X("TabLineFill", s:window, s:foreground, "reverse")
	call <SID>X("StatusLine", s:statusline, s:background2, "reverse")
	call <SID>X("StatusLineNC", s:foreground,s:statusline2, "NONE")
